<!-- style: editorial -->
<!-- footer: DSA · Arrays & Strings · తెలుగు గైడ్ -->
...
<div class="kicker">DSA · Arrays &amp; Strings</div>
<div class="rule"></div>
<div class="cover-title">Arrays &amp; Strings</div>
<div class="lede">అన్ని patterns కీ పునాది. Array manipulation, prefix sums, string handling — ఇక్కడే మొదలు.</div>
...
<div class="fig">
<div class="cap">Prefix / Suffix Products · నా ఎడమవైపు × నా కుడివైపు</div>
<svg viewBox="0 0 750 340"><text class="t-xs" x="0" y="14">ARRAY</text><rect class="n" x="60" y="24" width="52" height="34" rx="3"/><text class="t mid" x="86" y="46">1</text><rect class="n" x="115" y="24" width="52" height="34" rx="3"/><text class="t mid" x="141" y="46">2</text><rect class="n" x="170" y="24" width="52" height="34" rx="3"/><text class="t mid" x="196" y="46">3</text><rect class="n" x="225" y="24" width="52" height="34" rx="3"/><text class="t mid" x="251" y="46">4</text><text class="t-xs" x="0" y="98">PREFIX — నా ఎడమవైపు అన్నిటి లబ్ధం</text><rect class="n-good" x="60" y="108" width="52" height="34" rx="3"/><text class="t mid" x="86" y="130">1</text><rect class="n-good" x="115" y="108" width="52" height="34" rx="3"/><text class="t mid" x="141" y="130">1</text><rect class="n-good" x="170" y="108" width="52" height="34" rx="3"/><text class="t mid" x="196" y="130">2</text><rect class="n-good" x="225" y="108" width="52" height="34" rx="3"/><text class="t mid" x="251" y="130">6</text><text class="t-xs" x="0" y="182">SUFFIX — నా కుడివైపు అన్నిటి లబ్ధం</text><rect class="n-info" x="60" y="192" width="52" height="34" rx="3"/><text class="t mid" x="86" y="214">24</text><rect class="n-info" x="115" y="192" width="52" height="34" rx="3"/><text class="t mid" x="141" y="214">12</text><rect class="n-info" x="170" y="192" width="52" height="34" rx="3"/><text class="t mid" x="196" y="214">4</text><rect class="n-info" x="225" y="192" width="52" height="34" rx="3"/><text class="t mid" x="251" y="214">1</text><line class="ln-acc" x1="400" y1="125" x2="470" y2="125" marker-end="url(#aa)"/><line class="ln-acc" x1="400" y1="209" x2="470" y2="209" marker-end="url(#aa)"/><rect class="n-acc" x="490" y="150" width="52" height="34" rx="3"/><text class="t-w mid" x="516" y="172">24</text><rect class="n-acc" x="545" y="150" width="52" height="34" rx="3"/><text class="t-w mid" x="571" y="172">12</text><rect class="n-acc" x="600" y="150" width="52" height="34" rx="3"/><text class="t-w mid" x="626" y="172">8</text><rect class="n-acc" x="655" y="150" width="52" height="34" rx="3"/><text class="t-w mid" x="681" y="172">6</text><text class="t-acc mid" x="594" y="206">answer = prefix × suffix</text><rect class="n-acc" x="0" y="244" width="750" height="86" rx="4"/><text class="t-w mid" x="375" y="266">ఎందుకు division వాడకూడదు</text><text class="t-w-sm mid" x="375" y="288">సున్నా ఉంటే division పగులుతుంది — ఒక సున్నా ఉంటే ఒక్క చోట తప్ప అంతా 0,</text><text class="t-w-sm mid" x="375" y="304">రెండు సున్నాలుంటే అంతా 0. ఈ edge cases ని handle చేయడం కంటే</text><text class="t-w-sm mid" x="375" y="320">prefix × suffix చాలా శుభ్రం — మరియు interviewer అడిగేది కూడా అదే.</text></svg>
<div class="note"><b>సాధారణీకరణ:</b> "ప్రతి స్థానానికి — నన్ను మినహాయించి మిగతా అన్నిటి మీద ఒక operation" అనే ఏ problem కైనా ఇదే నమూనా. Sum, product, max — operation మారుతుంది, నిర్మాణం మారదు.</div>
</div>
...
<div class="fig">
<div class="cap">Read / Write pointers · in-place filtering</div>
<svg viewBox="0 0 750 402"><text class="t-xs" x="0" y="14">READ ముందుకి వెళ్తుంది · WRITE మంచివాటిని మాత్రమే పేర్చుతుంది</text><rect class="n-acc" x="30" y="26" width="52" height="34" rx="3"/><text class="t-w mid" x="56" y="48">1</text><text class="t-sm mid" x="56" y="75">0</text><rect class="n" x="85" y="26" width="52" height="34" rx="3"/><text class="t mid" x="111" y="48">1</text><text class="t-sm mid" x="111" y="75">1</text><rect class="n" x="140" y="26" width="52" height="34" rx="3"/><text class="t mid" x="166" y="48">2</text><text class="t-sm mid" x="166" y="75">2</text><rect class="n" x="195" y="26" width="52" height="34" rx="3"/><text class="t mid" x="221" y="48">2</text><text class="t-sm mid" x="221" y="75">3</text><rect class="n" x="250" y="26" width="52" height="34" rx="3"/><text class="t mid" x="276" y="48">3</text><text class="t-sm mid" x="276" y="75">4</text><text class="t-acc mid" x="56" y="90">W</text><text class="t-sm mid" x="56" y="108">R</text><rect class="n-acc" x="30" y="130" width="52" height="34" rx="3"/><text class="t-w mid" x="56" y="152">1</text><text class="t-sm mid" x="56" y="179">0</text><rect class="n" x="85" y="130" width="52" height="34" rx="3"/><text class="t mid" x="111" y="152">1</text><text class="t-sm mid" x="111" y="179">1</text><rect class="n-acc" x="140" y="130" width="52" height="34" rx="3"/><text class="t-w mid" x="166" y="152">2</text><text class="t-sm mid" x="166" y="179">2</text><rect class="n" x="195" y="130" width="52" height="34" rx="3"/><text class="t mid" x="221" y="152">2</text><text class="t-sm mid" x="221" y="179">3</text><rect class="n" x="250" y="130" width="52" height="34" rx="3"/><text class="t mid" x="276" y="152">3</text><text class="t-sm mid" x="276" y="179">4</text><text class="t-acc mid" x="56" y="194">W</text><text class="t-sm mid" x="140" y="194">R</text><text class="t-sm" x="360" y="150">R దగ్గరిది కొత్తదా? అవును → arr[W++] = arr[R]</text><text class="t-sm" x="360" y="168">కాదా? → W కదలదు, R మాత్రం ముందుకి</text><rect class="n-acc" x="30" y="224" width="52" height="34" rx="3"/><text class="t-w mid" x="56" y="246">1</text><text class="t-sm mid" x="56" y="273">0</text><rect class="n-acc" x="85" y="224" width="52" height="34" rx="3"/><text class="t-w mid" x="111" y="246">2</text><text class="t-sm mid" x="111" y="273">1</text><rect class="n-acc" x="140" y="224" width="52" height="34" rx="3"/><text class="t-w mid" x="166" y="246">3</text><text class="t-sm mid" x="166" y="273">2</text><rect class="n" x="195" y="224" width="52" height="34" rx="3"/><text class="t mid" x="221" y="246">—</text><text class="t-sm mid" x="221" y="273">3</text><rect class="n" x="250" y="224" width="52" height="34" rx="3"/><text class="t mid" x="276" y="246">—</text><text class="t-sm mid" x="276" y="273">4</text><text class="t-acc mid" x="200" y="288">చివరికి మొదటి W elements = జవాబు</text><rect class="n-good" x="0" y="306" width="750" height="86" rx="4"/><text class="t mid" x="375" y="328">ఈ pattern యొక్క గొప్పతనం</text><text class="t-sm mid" x="375" y="350">O(1) extra space — కొత్త array అవసరం లేదు.</text><text class="t-sm mid" x="375" y="366">W ఎప్పుడూ R ని దాటదు, కాబట్టి ఇంకా చదవని data ని పాడు చేయదు.</text><text class="t-sm mid" x="375" y="382">ఇదే "remove duplicates", "move zeroes", "remove element" అన్నిటికీ ఆధారం.</text></svg>
</div>
...
<div class="fig">
<div class="cap">Greedy on Arrays · ఒక్క సంఖ్యని మోసుకెళ్ళడం</div>
<svg viewBox="0 0 750 292"><text class="t-xs" x="0" y="14">JUMP GAME · ప్రతి index lo "నేను ఎంత దూరం వెళ్ళగలను"</text><rect class="n" x="60" y="26" width="52" height="34" rx="3"/><text class="t mid" x="86" y="48">2</text><text class="t-sm mid" x="86" y="75">0</text><rect class="n" x="115" y="26" width="52" height="34" rx="3"/><text class="t mid" x="141" y="48">3</text><text class="t-sm mid" x="141" y="75">1</text><rect class="n" x="170" y="26" width="52" height="34" rx="3"/><text class="t mid" x="196" y="48">1</text><text class="t-sm mid" x="196" y="75">2</text><rect class="n" x="225" y="26" width="52" height="34" rx="3"/><text class="t mid" x="251" y="48">1</text><text class="t-sm mid" x="251" y="75">3</text><rect class="n" x="280" y="26" width="52" height="34" rx="3"/><text class="t mid" x="306" y="48">4</text><text class="t-sm mid" x="306" y="75">4</text><text class="t-sm" x="0" y="100">ప్రతి అడుగులో reach = max(reach, i + nums[i])</text><rect class="n-good" x="60" y="120" width="52" height="30" rx="3"/><text class="t mid" x="86" y="141">2</text><rect class="n-good" x="115" y="120" width="52" height="30" rx="3"/><text class="t mid" x="141" y="141">4</text><rect class="n-good" x="170" y="120" width="52" height="30" rx="3"/><text class="t mid" x="196" y="141">4</text><rect class="n-good" x="225" y="120" width="52" height="30" rx="3"/><text class="t mid" x="251" y="141">4</text><rect class="n-good" x="280" y="120" width="52" height="30" rx="3"/><text class="t mid" x="306" y="141">8</text><text class="t-sm" x="360" y="141">reach ఇలా పెరుగుతుంది →</text><rect class="n-acc" x="0" y="170" width="366" height="86" rx="4"/><text class="t-w mid" x="183" y="192">Greedy ఎందుకు సరిపోతుంది</text><text class="t-w-sm mid" x="183" y="214">ఏ index ని దాటగలిగానో అది ముఖ్యం కాదు —</text><text class="t-w-sm mid" x="183" y="230">నేను చేరగలిగే అత్యంత దూరం ఒక్కటే ముఖ్యం.</text><text class="t-w-sm mid" x="183" y="246">అందుకే ఒక్క సంఖ్య చాలు, DP అవసరం లేదు.</text><rect class="n-bad" x="384" y="170" width="366" height="86" rx="4"/><text class="t mid" x="567" y="192">ఎప్పుడు greedy fail అవుతుంది</text><text class="t-sm mid" x="567" y="214">"ఇప్పుడు ఉత్తమమైనది" ఎప్పుడూ</text><text class="t-sm mid" x="567" y="230">"మొత్తానికి ఉత్తమమైనది" కాకపోతే.</text><text class="t-sm mid" x="567" y="246">అప్పుడు DP కి మారాలి (Coin Change లాంటివి).</text><text class="t-acc mid" x="375" y="282">i &gt; reach అయితే — ఆ index కి ఎప్పటికీ చేరలేం → false</text></svg>
</div>
...
<div class="fig">
<div class="cap">Two-pass · ఎడమ నుంచి ఒకసారి, కుడి నుంచి ఒకసారి</div>
<svg viewBox="0 0 750 328"><text class="t-xs" x="0" y="14">CANDY / TRAPPING RAIN WATER నమూనా</text><text class="t-sm" x="0" y="40">ఒక్క pass lo ఒక వైపు సమాచారం మాత్రమే తెలుస్తుంది</text><rect class="n-good" x="60" y="58" width="52" height="34" rx="3"/><text class="t mid" x="86" y="80">1</text><rect class="n-good" x="115" y="58" width="52" height="34" rx="3"/><text class="t mid" x="141" y="80">0</text><rect class="n-good" x="170" y="58" width="52" height="34" rx="3"/><text class="t mid" x="196" y="80">2</text><text class="t-sm" x="240" y="80">← ఎడమ నుంచి కుడికి: ఎడమవైపు గరిష్ఠం తెలుసు</text><rect class="n-info" x="60" y="110" width="52" height="34" rx="3"/><text class="t mid" x="86" y="132">2</text><rect class="n-info" x="115" y="110" width="52" height="34" rx="3"/><text class="t mid" x="141" y="132">0</text><rect class="n-info" x="170" y="110" width="52" height="34" rx="3"/><text class="t mid" x="196" y="132">1</text><text class="t-sm" x="240" y="132">← కుడి నుంచి ఎడమకి: కుడివైపు గరిష్ఠం తెలుసు</text><line class="ln-acc" x1="150" y1="150" x2="150" y2="178" marker-end="url(#aa)"/><rect class="n-acc" x="60" y="182" width="52" height="34" rx="3"/><text class="t-w mid" x="86" y="204">2</text><rect class="n-acc" x="115" y="182" width="52" height="34" rx="3"/><text class="t-w mid" x="141" y="204">0</text><rect class="n-acc" x="170" y="182" width="52" height="34" rx="3"/><text class="t-w mid" x="196" y="204">2</text><text class="t-acc" x="240" y="204">రెండింటినీ కలిపితే (max లేదా min) — పూర్తి జవాబు</text><rect class="n-acc" x="0" y="232" width="750" height="86" rx="4"/><text class="t-w mid" x="375" y="254">ఎందుకు రెండు passes అవసరం</text><text class="t-w-sm mid" x="375" y="276">ఒక element యొక్క జవాబు దాని రెండు వైపులా ఉన్న సమాచారం మీద ఆధారపడితే —</text><text class="t-w-sm mid" x="375" y="292">ఒక్క pass lo అది సాధ్యం కాదు (భవిష్యత్తు ఇంకా తెలియదు).</text><text class="t-w-sm mid" x="375" y="308">రెండు passes = O(n) time, O(n) space. Two pointers తో O(1) space కి తగ్గించొచ్చు.</text></svg>
</div>
...
<div class="fig">
<div class="cap">String Parsing · tokens ని ఏరడం</div>
<svg viewBox="0 0 750 292"><text class="t-xs" x="0" y="14">STRING PARSING · స్థితిని మోసుకెళ్ళే ఒక్క pass</text><rect class="n" x="30" y="26" width="52" height="34" rx="3"/><text class="t mid" x="56" y="48">h</text><rect class="n" x="85" y="26" width="52" height="34" rx="3"/><text class="t mid" x="111" y="48">e</text><rect class="n" x="140" y="26" width="52" height="34" rx="3"/><text class="t mid" x="166" y="48">l</text><rect class="n" x="195" y="26" width="52" height="34" rx="3"/><text class="t mid" x="221" y="48">l</text><rect class="n" x="250" y="26" width="52" height="34" rx="3"/><text class="t mid" x="276" y="48">o</text><rect class="n" x="305" y="26" width="52" height="34" rx="3"/><text class="t mid" x="331" y="48"> </text><rect class="n" x="360" y="26" width="52" height="34" rx="3"/><text class="t mid" x="386" y="48">w</text><rect class="n" x="415" y="26" width="52" height="34" rx="3"/><text class="t mid" x="441" y="48">o</text><text class="t-xs" x="0" y="86">రెండు సాధారణ వ్యూహాలు</text><rect class="n-good" x="0" y="96" width="366" height="86" rx="4"/><text class="t mid" x="183" y="118">1 · Split &amp; filter</text><text class="t-sm mid" x="183" y="140">s.split(/\s+/).filter(Boolean)</text><text class="t-sm mid" x="183" y="156">సులభం, చదవడానికి బాగుంటుంది.</text><text class="t-sm mid" x="183" y="172">కానీ కొత్త array — O(n) extra space.</text><rect class="n-info" x="384" y="96" width="366" height="86" rx="4"/><text class="t mid" x="567" y="118">2 · Manual pointer scan</text><text class="t-sm mid" x="567" y="140">i ని కదిలిస్తూ, spaces ని దాటుతూ,</text><text class="t-sm mid" x="567" y="156">ఒక్కో token ని చేతితో పేర్చడం.</text><text class="t-sm mid" x="567" y="172">O(1) space — interviewer ఇష్టపడతాడు.</text><rect class="n-acc" x="0" y="196" width="750" height="86" rx="4"/><text class="t-w mid" x="375" y="218">తరచుగా మర్చిపోయే edge cases</text><text class="t-w-sm mid" x="375" y="240">ముందు/వెనుక spaces · వరుసగా బహుళ spaces · ఖాళీ string</text><text class="t-w-sm mid" x="375" y="256">ఒకే ఒక్క word · అన్నీ spaces మాత్రమే</text><text class="t-w-sm mid" x="375" y="272">ఇవి ప్రత్యేకంగా test చేయడం — string problems lo సగం bugs ఇక్కడే.</text></svg>
</div>
...
---
<div class="fig">
<div class="cap">Rotate Array · మూడు reversals trick</div>
<svg viewBox="0 0 750 382"><text class="t-xs" x="0" y="14">ROTATE ARRAY k=2 · మూడు reversals</text><rect class="n" x="60" y="26" width="52" height="34" rx="3"/><text class="t mid" x="86" y="48">1</text><rect class="n" x="115" y="26" width="52" height="34" rx="3"/><text class="t mid" x="141" y="48">2</text><rect class="n" x="170" y="26" width="52" height="34" rx="3"/><text class="t mid" x="196" y="48">3</text><rect class="n" x="225" y="26" width="52" height="34" rx="3"/><text class="t mid" x="251" y="48">4</text><rect class="n" x="280" y="26" width="52" height="34" rx="3"/><text class="t mid" x="306" y="48">5</text><text class="t-sm" x="400" y="48">అసలు array</text><line class="ln-acc" x1="180" y1="68" x2="180" y2="92" marker-end="url(#aa)"/><rect class="n" x="60" y="96" width="52" height="34" rx="3"/><text class="t mid" x="86" y="118">5</text><rect class="n" x="115" y="96" width="52" height="34" rx="3"/><text class="t mid" x="141" y="118">4</text><rect class="n" x="170" y="96" width="52" height="34" rx="3"/><text class="t mid" x="196" y="118">3</text><rect class="n" x="225" y="96" width="52" height="34" rx="3"/><text class="t mid" x="251" y="118">2</text><rect class="n" x="280" y="96" width="52" height="34" rx="3"/><text class="t mid" x="306" y="118">1</text><text class="t-sm" x="400" y="118">1 · మొత్తం reverse</text><line class="ln-acc" x1="180" y1="138" x2="180" y2="162" marker-end="url(#aa)"/><rect class="n-acc" x="60" y="166" width="52" height="34" rx="3"/><text class="t-w mid" x="86" y="188">4</text><rect class="n-acc" x="115" y="166" width="52" height="34" rx="3"/><text class="t-w mid" x="141" y="188">5</text><rect class="n" x="170" y="166" width="52" height="34" rx="3"/><text class="t mid" x="196" y="188">3</text><rect class="n" x="225" y="166" width="52" height="34" rx="3"/><text class="t mid" x="251" y="188">2</text><rect class="n" x="280" y="166" width="52" height="34" rx="3"/><text class="t mid" x="306" y="188">1</text><text class="t-sm" x="400" y="188">2 · మొదటి k ని reverse</text><line class="ln-acc" x1="180" y1="208" x2="180" y2="232" marker-end="url(#aa)"/><rect class="n" x="60" y="236" width="52" height="34" rx="3"/><text class="t mid" x="86" y="258">4</text><rect class="n" x="115" y="236" width="52" height="34" rx="3"/><text class="t mid" x="141" y="258">5</text><rect class="n-acc" x="170" y="236" width="52" height="34" rx="3"/><text class="t-w mid" x="196" y="258">1</text><rect class="n-acc" x="225" y="236" width="52" height="34" rx="3"/><text class="t-w mid" x="251" y="258">2</text><rect class="n-acc" x="280" y="236" width="52" height="34" rx="3"/><text class="t-w mid" x="306" y="258">3</text><text class="t-sm" x="400" y="258">3 · మిగతావాటిని reverse</text><rect class="n-acc" x="0" y="286" width="750" height="86" rx="4"/><text class="t-w mid" x="375" y="308">ఎందుకు ఇది పని చేస్తుంది</text><text class="t-w-sm mid" x="375" y="330">Reverse చేయడం వల్ల చివరి k elements ముందుకి వస్తాయి — కానీ తలక్రిందులుగా.</text><text class="t-w-sm mid" x="375" y="346">ఆ రెండు ముక్కలని విడిగా మళ్ళీ reverse చేస్తే అవి సరైన క్రమానికి వస్తాయి.</text><text class="t-w-sm mid" x="375" y="362">O(1) space · O(n) time — కొత్త array అవసరం లేదు.</text></svg>
<div class="note"><b>k > n అయితే</b> — <code>k %= n</code> చేయడం మర్చిపోవద్దు, లేకపోతే index దాటిపోతుంది. ఇది interview lo అత్యంత సాధారణంగా మిస్ అయ్యే line.</div>
</div>
