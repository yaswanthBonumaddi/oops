...
ఒక user post పెడతాడు. అతని followers అందరి timeline lo అది కనిపించాలి. Timeline అంటే — నేను follow చేసే వాళ్ళందరి posts, **కొత్తవి ముందు**.
...
**పైన 0.1% users మొత్తం పనిలో 29.5% సృష్టిస్తారు.** 200 మంది, 7 కోట్ల writes lo 2 కోట్లు.
...
సహజమైన మొదటి design. ప్రతి user కి ఒక **inbox** — అతని timeline, ముందే తయారుగా:
...
కాబట్టి ఒక్క user ని చూస్తే ఈ design <b>వేగంగా</b> కనిపిస్తుంది. Load test lo ఒక user తో పరీక్షిస్తే అది <b>pass</b> అవుతుంది.<br><br>
...
కానీ users చురుకుదనం కూడా ఒక power law. చాలామంది ఖాతా తెరిచి మర్చిపోతారు.
...
| 3 | Back-fill చేశాను, కానీ **"celebrity" ని user లక్షణం**గా చూశాను — follower సంఖ్య మారితే posts రంధ్రంలో పడతాయి | 1,000 |
...
ప్రయత్నం 3 వేరే ఆకారం, మరియు అది నాకు బాగా నచ్చింది: <b>"Celebrity" అనేది user లక్షణం కాదు — అది <i>ఈ post</i> యొక్క లక్షణం.</b> Follower సంఖ్య మారుతూ ఉంటుంది; ఒక post push అయిందా లేదా అన్నది post పెట్టిన క్షణంలోనే తేలిపోతుంది, మరియు అది <b>అక్కడే నమోదు కావాలి</b>.<br><br>
...
Skip అయినా, trim అయినా — ఆ user `#dirty` lo చేరతాడు. `timeline()` lo:
...
అందుకే నాకు ఏడు ప్రయత్నాలు పట్టింది. ప్రతిసారీ నా code <b>99.7% సరిగ్గా</b> ఉండేది — మరియు ఆ 0.3% lo ఒక user యొక్క ఒక post <b>శాశ్వతంగా</b> అదృశ్యమయ్యేది.<br><br>
ఒక unit test ఈ పరిస్థితిని ఎప్పటికీ రాయదు: "ఒక user inactive గా ఉండగా ఒక post రావాలి, తర్వాత అతను active అవ్వాలి, తర్వాత ఇంకో push రావాలి, తర్వాత అతను timeline అడగాలి." ఆ మూడు అడుగుల కలయికని <b>ఎవరూ ఊహించరు</b>.<br><br>
...
4. **"Celebrity" అనేది post యొక్క లక్షణం, user లక్షణం కాదు.** ఇది చెప్తే మీరు దీన్ని నిజంగా రాశారని తెలుస్తుంది.
...
అది మీ timeline యొక్క **గరిష్ఠ లోతు** ని నిర్ణయిస్తుంది. నా code lo `inboxCap` దాటితే పాతవి trim అవుతాయి — మరియు §10 ప్రయత్నం 6 lo నేర్చుకున్నట్టు, **ఆ trim ఒక రంధ్రం**. Trim అయిన user inbox ఇక పూర్తి కాదు, కాబట్టి లోతైన pagination **తప్పకుండా** మూలం నుంచి రావాలి. నిజమైన systems ఇదే చేస్తాయి: మొదటి పేజీ inbox నుంచి, లోతైన పేజీలు posts table నుంచి.

**"ఒక user 5,000 మందిని follow చేస్తే?"**
...
**1. సగటు ఒక అబద్ధం.** p50 93 followers, గరిష్ఠం 19 లక్షలు — 20,000 రెట్లు తేడా. మీ design సగటు నుంచి కాదు, **తోక నుంచి** రావాలి. పైన 0.1% users 29.5% పని సృష్టిస్తారు.
...
**6. "Celebrity" అనేది user లక్షణం కాదు, post లక్షణం.** ఆ నిర్ణయం post పెట్టిన క్షణంలో తీసుకుంటాం — కాబట్టి అది **అక్కడే నమోదు కావాలి**. లేకపోతే follower సంఖ్య మారినప్పుడు posts రెండు వ్యూహాల మధ్య రంధ్రంలో పడతాయి.
...
**9. 0.3% సార్లు కనిపించే bug ఒక చిన్న bug కాదు.** నాలుగు మార్పులు **300 lo ఒక్కసారే** పట్టుబడ్డాయి. అవి staging lo ఎప్పటికీ కనిపించవు — అవి ఒక user కి, ఒకసారి, ఒక post శాశ్వతంగా పోగొట్టి కనిపిస్తాయి.
