...
ఒక shopping cart కి జవాబు "రెండింటినీ కలపు". ఒక counter కి "కూడు". ఒక profile పేరుకి "user ని అడుగు". <b>ఈ మూడూ వేర్వేరు, మరియు database కి తెలియదు.</b>
</div>
...
ఇప్పుడు ఒక shopping cart తీసుకుందాం. ముగ్గురు users (లేదా ఒకే user మూడు tabs lo) **వేర్వేరు వస్తువులను** ఏకకాలంలో చేరుస్తారు. సరైన జవాబు స్పష్టం: **మూడూ cart lo ఉండాలి.**
...
ముగ్గురు users మూడు వేర్వేరు వస్తువులను చేర్చారు. Database ఒకదాన్ని ఉంచింది. <b>ఎవరికీ ఒక దోషం కనిపించలేదు.</b>
</div>
...
> Cart lo X మరియు Y ఉన్నాయి. user **X ని తొలగిస్తాడు** (replica 0 మీద).
...
<b>Cart</b> → OR-Set. <b>Counter</b> → కూడిక. <b>Profile పేరు</b> → user ని అడగడం. <b>Log</b> → రెండూ ఉంచడం.<br><br>
