...
<svg viewBox="0 0 750 260"><circle cx="180" cy="130" r="105" fill="none" stroke="#d9d3c6" stroke-width="2"/><circle cx="180" cy="25" r="10" fill="#17203a"/><text class="t-sm mid" x="180" y="7">Node A</text><circle cx="271" cy="182" r="10" fill="#17203a"/><text class="t-sm " x="299" y="188">Node B</text><circle cx="89" cy="182" r="10" fill="#17203a"/><text class="t-sm end" x="61" y="188">Node C</text><circle cx="255" cy="55" r="6" fill="#e2653a"/><text class="t-sm" x="266" y="50">key "x"</text><path class="ln-acc" d="M262 48 A 105 105 0 0 0 190 28" marker-end="url(#aa)"/><text class="t-sm mid" x="180" y="126">hash ring</text><text class="t-sm mid" x="180" y="142">0 → 2³²</text><rect class="n-good" x="320" y="20" width="430" height="70" rx="4"/><text class="t mid" x="535" y="42">నియమం</text><text class="t-sm mid" x="535" y="64">Key ని hash చేసి ring మీద పెట్టు. అక్కడి నుంచి సవ్య దిశలో మొదట కనిపించే node దాని</text><text class="t-sm mid" x="535" y="80">యజమాని.</text><rect class="n-bad" x="320" y="96" width="430" height="72" rx="4"/><text class="t mid" x="535" y="118">సాధారణ hash తో పోలిస్తే</text><text class="t-sm mid" x="535" y="140">hash(key) % N — N మారితే దాదాపు అన్ని keys కదులుతాయి. ఒక node చేర్చడానికి మొత్తం cluster</text><text class="t-sm mid" x="535" y="156">ని rebalance చేయాలి.</text><rect class="n-acc" x="320" y="178" width="430" height="72" rx="4"/><text class="t-w mid" x="535" y="200">Virtual nodes ఎందుకు తప్పనిసరి</text><text class="t-w-sm mid" x="535" y="222">ఒక్కో physical node ని ring మీద 100+ చోట్ల పెట్టడం. లేకపోతే పంపిణీ అసమానం, మరియు ఒక node</text><text class="t-w-sm mid" x="535" y="238">పోతే దాని భారం మొత్తం ఒక్క పొరుగువాడి మీద పడుతుంది.</text></svg>
</div>
